...
class AssetCallbackBeta(ICallback):
    def __init__(self, button_name, callback_name=None):
        super(AssetCallbackBeta, self).__init__(button_name, callback_name)

        self.mr = MarketRequest('./settings/settings.json', './settings/asset.json', beta=True)
